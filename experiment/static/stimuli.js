var stimuli = [
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      "Malaysia announced having arrested 120 people in its largest anti-organ harvesting crackdown. The ring which was operating from a small village in the Ipoh prefecture, is said to have kidnapped more than 70 people in less than 6 months, reselling their organs on the black market. The Malaysian commissioner reported that the investigation is in its early stages and they fear that they might discover that the trafficking was operating at a wider level, even often with the support of families of the kidnapped persons. This indicates a wider social issue were the consequences of the Covid lockdown have forced a major part of the rural population to fall under the poverty line. Without resources and little economic prospects, many families have turned to unethical and criminal activities .",
    stimulus:
  ...
  },
  {
    ...
    topic: "science",
    raw_stimulus:
      "With the availability of smart devices now adays we can even identify our heartbeat at anywhere. Additionally, these devices even have the ability to analyse the trends and potential risks to our lives. Apart from this the stress level of a person can also be monitored. Companies in singapore has the ability to monitor the stress levels of their employees. This helps them to understand the mental status of the person. Afterwards actions based on different indivdals are taken to upkeep their work to improve the mental wellbeing. This helps the companies to identify the workload of a person and deletgate it if necessary. Also this leads to a happy working force.",
    stimulus:
  ...
  },
  {
    ...
    topic: "science",
    raw_stimulus:
      "Singapore's Comfort Delgro just announced the introduction of self-driving vehicles in Singapore. The Land and Transport Authority just confirmed that it granted a license to the well known cab company for a pilot experiment that could lead to generalization of self driving vehicles. Though the response is highly positive from passengers, increasing concerns have been voiced regarding the potential impact to the current 16.000 taxi uncles staffing the company. Mr Wei Lim, driving with Comfort since more than 20 years, said: \"In the name of progress and profit seeking we often forget that there are people behind the wheel. I don't know how I will support my family if I cannot continue to drive a car. I have driven all my life and have not developed other skills.\". \n \n When confronted by our reporters, Comfort Delgro said that they have no plan yet to replace their employees by self driving vehicles, however the cost pressure have increased drastically during and after Covid and the current model with competition from Private Hire Vehicles is not sustainable anymore.",
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      "Many BLACKPINK fans were seen at the airport on the 3rd of August in 2023. These fans caused a ruckus in Terminal 1 as they jostled for a good position to catch a glimpse of their favourite artists. The popular girl group was slated to arrive at the airport early in the morning on the 4th of August. However, crowds began to gather as early as 8am on the 3rd of August. This was to great annoyance of the many travellers hoping to get from the airport to their next destination. The airport staff were left flustered as to what should be done. In the end, the police were called to disperse the crowds late at night. By 8pm on the 3rd of August, the airport was back to normal.",
    stimulus:
  ...
  },
  {
    ...
    topic: "economy",
    raw_stimulus:
      "The market for crude oil has once again crashed globally, following 2 spikes in all time high price events. According to the WTI and Brent Crude indexes, the prices of crude oil per barrel has dropped from $90USD to $20USD early this morning. This is largely due to the sudden declaration that the oil field in the middle easter regions has found a secondary oil field nearby, and will lead to higher inventory of crude oil extracted. Another large news was the declaration of 80% transition of energy source to greener energy sources in China. With China purchasing 40% of world crude to power the country today, the declaration will mean a sudden gap in demand for crude oil. This sudden increase in supply and decrease in demand shift the demand-supply curve, which means a sharp decrease in market price. Dealers of crude oil begin panic selling their stocks, pushing down the price even more.",
    stimulus:
  ...
  },
  {
    ...
    topic: "politics",
    raw_stimulus:
      "Today, the US Federal announced that they will waive off tariff on imports for the next six months. This is a surprising news to many people as they do not expect it. This new policy is likely to benefit millions of businesses. Businesses expects a reduction in at least 15% of their costs in the long run. The new policy is also likely to open out US market to more foreign business and attracts more foreign companies to US. Experts expect at least a 30% increase in US import market. Consumers in US are also likely to benefit with lower prices of products. The new policy is expected to commence in 1 September.",
    stimulus:
  ...
  },
  {
    ...
    topic: "politics",
    raw_stimulus:
      "In Japan, there exists a policy which the employers are not allowed to fire their employees even though they are found to be slacking during their work. Although it seems to be quite unreasonable, there is rarely any opposite voice from the employers. Thus, the employers come out with other ways to deal with this existing policy. Once they find that the employee does not provide enough value that the company needs, they will arrange the employee to shift to other locations that quite far from their place of residency. This causes the employees to be quite hassled to commute for a longer time to reach the office. At the end, the employee will be unable to withstand the difficulties encountered and will choose to resign themselves. Ultimately, the company achieves its goal.",
    stimulus:
  ...
  },
  {
    ...
    topic: "science",
    raw_stimulus:
      "Fish bone is generally the waste produced after consuming fish. It is normally discarded and incinerated to ash before sending to landfill. This had caused the landfill to accumulate faster than expected. Hence, there was extensive research led by a group of scientists from the Korea Marine Academy. Their recent scientific discovery regarding the use of fish bones to make useful products such as paper made the headline in the academia industry in South Korea. The fish bone was first cleaned thoroughly to remove any excess meat. Once cleaned, it will be sent for drying under 100-degree Celsius to ensure that no moisture is left. After drying, it will be crashed into powder before the next processing, where high pressure will be used to mold the powder into useful products.",
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      'There has been a sudden influx of college dropouts in the United States, with many citing how they feel like they have the capabilities of becoming the next Mark Zuckerberg.\n \n \n \n This brings up the concern of how important the college degree would be and it\'s relevance in the current world. Could anyone just get up and leave, taking a leap of faith with just a high school diploma?\n \n \n \n It also ties into the problem of social media and it\'s influence on the youths of today. Many have attributed their sudden confidence in their leap of faiths to seeing many successful entrepeneurs on social media, and their "stories and tips".\n \n \n \n What if these "entrepeneurs" are just content creators, or they are just making those content for flak? Would the youths of today be able to discern truth from these, and weigh their options objectively?',
    stimulus:
  ...
  },
  {
    ...
    topic: "politics",
    raw_stimulus:
      'A policy was changed in Malaysia, which regarded to the access of emergency country funds. Previously, the funds could only be accessed after approval by the lawmakers in Parliament. However, after the change, the national government can now access these funds with only the approval of the finance ministers, raising concerns for corruption, and ease of taking out emergency funds for personal uses. The worries are not unfounded, after the infamous corruption case of Ex-PM Muhyiddin, and few others. Though the policy was changed with reasons cited "so that emergency funds can be access quickly to deal with the pandemic", there is little trust on what will be done with this privilege after the emergency is over.',
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      "The recent incident of a man stabbing people in the street of Korea has led to concerns about safety in the country. This incident involved a man who get out of his car and stab people. 14 people was injured, and the man was arrested. Many locals have expressed the fear of walking in the street. They will likely be more careful when walking in the street due to this incident. The country's tourism will likely be affected as well due to the fear of getting stab while walking the street. This will bring turmoil to the country economic. This incident has also risen security concerns in the country.",
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      "Hollywood workers are continuing their strikes against the big streaming companies, as more and more shows and movies projects get delayed because of it.\n \n There has been not much progress since the start of the strikes, with a compromise looking less likely by the day.\n \n Aaron Paul, star of the show Breaking Bad, highlighted the recent resurgence of people watching the show on Netflix.\n \n He claims that despite the big streaming numbers, he does not receive a single cent of revenue from Netflix.\n \n Hollywood writers are facing the same issue. \n \n They might have written the most popular episode of a particular show, but are only paid a one-off fee prior to it airing.\n \n No matter how well it does on the streaming platform, they are not entitled to any money from it at all.\n \n The big streaming companies are unlikely to budge from their position, especially since they are benefitting from it.",
    stimulus:
  ...
  },
  {
    ...
    topic: "economy",
    raw_stimulus:
      'Ever since the government halted the "stop at 2" campaign, the growth of Singapore has for decades depended on the import of foreign expats and laborers. For Singapore to progress economically, we need new blood because Singaporeans, like all other people in developed countries has a declining birthrate. But is economical progress what Singaporeans truly want today? Our government sure seems to think so, especially during the 2000-2015 period, where almost any one can get a PR and most people with some effort can get a citizenship. But it does seem like the government has sensed the resentment, the sheer influx of foreigners especially from China has somewhat destabilized the social fabric of Singapore. Even those ethnically Chinese, the Chinese in Singapore are generally ideologically and culturally different. So, the question remains, a question that Singaporeans and the government needs to answer. Is the cost of economical growth in Singapore worth it? Are we willing to bear the cost?',
    stimulus:
  ...
  },
  {
    ...
    topic: "economy",
    raw_stimulus:
      'Singapore is expected to experience a surge in tourism as we head further and further away from the pandemic.\n In fact, in this coming year, we are expected to see an exponential increase in tourism levels as popular artists such as "The Weeknd" and "Taylor Swift" chose singapore as destinations for their world tours.\n This has economic effects in the spending habits of locals too. As their are overwhelmed with excitement to see their famous artists perform live after so many years of lockdown of any fun activities due to the pandemic for the past few years.\n Local fans went through extreme means in order to attempt to purchase tickets. Some going as far as queuing outside of post offices that sell these tickets the day before ticket sales.\n The Singapore government is the happiest around this as the concert alone is expected to make millions in revenue.',
    stimulus:
  ...
  },
  {
    ...
    topic: "politics",
    raw_stimulus:
      "Sri Lanka recently increased their personal tax rates significantly. New personal tax rates are staring from 6% to 36%. Previous tax rates were ranging from 5% to 20%. This has affected lot of skilled labours and professionals. In the context of inflation is high as 50% and also with the higher interest rates, people can not live their normal life with the implementation of this new tax implementation. Most of the professionals are obtained loans from banks and each and every month they have to serve those installments. However, with new tax policy their disposable income was reduced and unable to serve loan installments as usual. Due to this reason most of the professionals are leaving the country. This made country to have a shortage of professionals in many fields such as hospitals etc. Some are trying evade taxing since it is not a fair at all. So professionals do not have a good days ahead in future with this tax policy is on the system.",
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      "In the recent months, Singapore has seen an increase in the number of wild chickens in neighborhoods and parks. At 7am in the neighborhood park, we see chicken Mother with their young chicks and looking for food. In some neighborhood areas, we also spotted people feeding the chickens. This could be one of the reasons for the rising number of chickens in neighborhood. The rise of chickens in the neighborhood areas has risen concerns of bird flu. Many Singaporeans express the fear that the rising number chicken in neighborhood may led to spread of bird flu. National Environmental Authority (NEA) has express that they will take steps to reduce the number of wild chickens in neighborhood. They also encourage Singaporean not to feed the wild chickens.",
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      'Scams have been on the rising trend these few years. It was more prevalent during the Covid period and continued to stay high in numbers even in post-Covid period. During the Covid period, many types of new scam methods had surfaced in the social media platforms such as Facebook and Instagram. Scams such as job scams, love scams and investment scams were among the most common tactics used by scammers. Scammers involved in love and investment scams used the "Pig butchering method". The scammer will grow and fatten the pig by getting into online romantic relationship with the victim to gain their trust. An investment platform will then be introduced to the victim, where the scammers will convince the victim to invest their money using the website given to them. The victim will only know that they got scammed when they failed to withdraw their earnings and blocked by the scammer.',
    stimulus:
  ...
  },
  {
    ...
    topic: "social",
    raw_stimulus:
      "A recent survey by the Ministry of Health (MOH) has found that 9 in 10 Singaporeans consume too much sodium in their diet. In their survey, MOH tracked the diets and health of more than 15000 people. Their survey also found that incidence levels of hypertension has also nearly doubled since the past decade. Obesity levels have also risen in the past few years, while physical activity levels have decreased in the same period. Minister of Health Ong Ye Kung told reporters that while the results of the survey are not trending in the right direction, new initiatives will hopefully reverse these trends. These include mandatory grading and labelling of drinks based on their sugar and fat content sold in supermarkets, while the same system will be rolled out to freshly prepared drinks by the end of 2023. Regarding sodium levels in food, Minister Ong said that there have been moves to call on the industry to reduce sodium levels in dishes. These include supplying F&B outlets with low-sodium salt, and pushing hawkers to use low-sodium ingredients in their food.",
    stimulus:
