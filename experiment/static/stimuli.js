var stimuli = [
  ...
  },
  {
    ...
    irrelevant_relevant: "R",
    topic: "politics",
    stimulus: "Owning a vehicle may be a dream of some living in Singapore. However, the recent price for the Certificate of Entitlement (COE) has shown that such a dream may be difficult to achieve for some. The trend for the COE has been tending toward an increase in recent years. Some people say that this could be a measure to encourage people living in Singapore to take public transport. In order to own a car, buyers would have to pay not just for a car, but also, the COE. This makes the purchase one with a hefty cost. The cost of owning a car is, therefore, much higher, compared to owning a car overseas. If the trend continues to increase, would owning a car be a dream for average Singaporeans? We can only tell with time.",
    excerpt_words: "135"
  },
  {
    excerpt_num: "171",
